      ...
      <tns:DataTrade>
         <xsl:for-each select="/ns0:DataTrade/ns0:body/ns0:trade">
            <tns:trade>
               ...
               <tns:Price>
                  <xsl:value-of select="concat(ns0:price,'&#xD;')"/>
               </tns:Price>
            </tns:trade>
         </xsl:for-each>
      </tns:DataTrade>
