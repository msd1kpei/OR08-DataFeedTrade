            ...
            <xsl:for-each select="/ns0:kpeiInbound/ns0:body/ns0:content/ns0:deal">
               <ns1:trade>
                  <xsl:for-each select="ns0:trade/ns0:extensions/ns0:extension">
                     <xsl:if test="oraext:compare-ignore-case(ns0:name,&quot;INVESTORID&quot;) = 0">
                        <ns1:investorID>
                  ...
                  <xsl:for-each select="ns0:trade/ns0:extensions/ns0:extension">
                     <xsl:if test="oraext:compare-ignore-case(ns0:name,&quot;ACCOUNT&quot;) = 0">
                        <ns1:CMCode>
                           <xsl:value-of select="substring(ns0:value,1,2)"/>
                        </ns1:CMCode>
                        <ns1:investorID/>
                     </xsl:if>
                  </xsl:for-each>
                  ...
                  <xsl:choose>
                     <xsl:when test="oraext:compare-ignore-case(ns0:trade/ns0:tradeHeader/ns0:buySell,&quot;SELL&quot;) = 0">
                        <ns1:amount>
