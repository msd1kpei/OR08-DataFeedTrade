  ...
  <oracle-xsl-mapper:schema>
      ...
      <oracle-xsl-mapper:mapSources>
         <oracle-xsl-mapper:source type="XSD">
            <oracle-xsl-mapper:schema location="../xsd/DataTrade-request.xsd"/>
            <oracle-xsl-mapper:rootElement name="DataTrade" namespace="http://www.kpei.co.id/DataTradeRequest"/>
         </oracle-xsl-mapper:source>
      </oracle-xsl-mapper:mapSources>
      <oracle-xsl-mapper:mapTargets>
         <oracle-xsl-mapper:target type="XSD">
            <oracle-xsl-mapper:schema location="../xsd/DataTradeOutput.xsd"/>
            <oracle-xsl-mapper:rootElement name="DataTrade" namespace="http://www.kpei.co.id/writeFileDataTrade"/>
