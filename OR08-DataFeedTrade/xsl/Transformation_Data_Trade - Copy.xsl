...
<?oracle-xsl-mapper
  ...
  <mapSources>
    <source type="XSD">
      <schema location="../xsd/DataTrade-request.xsd"/>
      <rootElement name="DataTrade" namespace="http://www.kpei.co.id/DataTradeRequest"/>
    </source>
  </mapSources>
  <mapTargets>
    <target type="XSD">
      <schema location="../xsd/DataTradeOutput.xsd"/>
      <rootElement name="DataTrade" namespace="http://www.kpei.co.id/writeFileDataTrade"/>
    </target>
  </mapTargets>
  <!-- GENERATED BY ORACLE XSL MAPPER 11.1.1.3.0(build 100415.2045.2557) AT [WED FEB 29 12:39:26 ICT 2012]. -->
?>
<xsl:stylesheet version="1.0"
                ...
                xmlns:tns="http://www.kpei.co.id/writeFileDataTrade"
                xmlns:ns0="http://www.kpei.co.id/DataTradeRequest"
                xmlns:socket="http://www.oracle.com/XSL/Transform/java/oracle.tip.adapter.socket.ProtocolTranslator"
                xmlns:ldap="http://schemas.oracle.com/xpath/extension/ldap"
                exclude-result-prefixes="xsi xsl xsd ns0 nxsd tns bpws xpath20 mhdr bpel2 oraext dvm hwf med ids bpm xdk xref ora socket ldap">
  <xsl:template match="/">
    <tns:DataTrade>
